  ...
  return (
    ...
    <div className="container">
      ...
      <div className="section-title">
        <h2>Portfolio</h2>
        <p>A portfolio is a collection of financial investments like stocks, bonds, commodities, cash, and cash
          equivalents, as well as their fund counterparts. A person's tolerance for risk, investment objectives, and
          time horizon are all critical factors when assembling and adjusting an investment portfolio.</p>
      </div>
